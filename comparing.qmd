...
* There have been some broad ecosystem shifts, e.g., past conifer mapped as shrubland currently.  
...
* The Rocky Mountain Lodgepole Pine Forest shows the greatest differences between reference and current amounts of succession classes, with a substantial over representation of succession class C on the landscape today.
* Some BpSs are missing succession classes on the landscape today, such as the Rocky Mountain Subalpine Dry-Mesic Spruce-Fir Forest and Woodland which appears to be missing succession class D currently.  
